                ...
                <!-- <a href="products.php" class=" font-poppins text-[14px] font-medium  ">Products</a> -->
                      ...
                      <div class="flex items-center justify-end gap-6 basis-1/4">
                            <div id="cart" class="relative flex items-end gap-2 cursor-pointer">
                                ...
                                <div id="cartContainer" class="fixed hidden flex-col  justify-center items-center top-[80px] right-[10%] min-w-[250px] max-w-[400px] h-[200px] bg-white border border-[#d3d3d3] rounded-lg py-4 px-3">
                                    <p>Empty cart... </p> 
                        ...
                        <button id="loginBtn" class=" rounded bg-[#1d1d1d] text-white  px-4 py-1 text-lg max-[1030px]:hidden">Log in</button>
                </div>
        </nav>
