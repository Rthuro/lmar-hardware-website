...
<body >
    ...
    <main class=" flex self-center justify-around w-full max-w-[1350px] h-fit mx-auto gap-4 mt-[200px] mb-[50px] max-[1380px]:mt-3 ">
        <form action="" method="get" class="filter w-1/4 border-[1px] h-fit bg-white p-4   max-[1380px]:hidden ">
